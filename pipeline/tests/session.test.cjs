...
assert.equal(crypto.createHash('sha256').update(JSON.stringify(originalBaseline)).digest('hex'),'ff5e41f50a83c59ca201727bf4867aee2f0246f2eea35c53ef87b1f665b7696f','0–45 changed beyond logged usage corrections, removal of 0:10 and the Goyang million example');
